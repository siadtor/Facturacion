 ...
 */
public class VistaFacturaReporte extends JFrame{
    
    public void vistaReporte(Date fechaInicial, Date fechaFinal) throws JRException{
    FacturaServicio servicio = new FacturaServicio();
    
    //Ruta donde se encuentra el archivo que nos ayuda a crear el reporte.
    String file = "/facturacion/fx/ReporteFactura.jasper";
    ...
    JRBeanCollectionDataSource beanColDataSource = 
            new JRBeanCollectionDataSource(servicio.obtenerFacturas(fechaInicial, fechaFinal), false);

 ...
 */
public class FormGraficosController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private TableColumn<Factura, Integer> colCod;
    ...
    @FXML
    private TableColumn<Factura, Boolean> colActiva;
    ...
    try{
        ...
        Date fechaInicial = new SimpleDateFormat("yyyy-MM-ddHH:mm:ss")
                .parse(getFecha(date) + " 00:00:00");
        
        date = LocalDate.now();
        
        Date fechaFinal = new SimpleDateFormat("yyyy-MM-ddHH:mm:ss")
                .parse(getFecha(date) + " 23:59:59");
        
        factura = FacturaServicio.obtenerFacturas(fechaInicial, fechaFinal);
    } catch (ParseException ex){
        Logger.getLogger(FormGraficosController.class.getName()).log(Level.SEVERE, null,ex);
    }
